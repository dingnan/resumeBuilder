...
### Setup upstream, do this once

`git remote add upstream git@github.com:jitinnair1/autoCV.git`

`git remote -v`

origin git@github.com:dingnan/resumeBuilder.git (fetch)

origin git@github.com:dingnan/resumeBuilder.git (push)

upstream git@github.com:jitinnair1/autoCV.git (fetch)

upstream git@github.com:jitinnair1/autoCV.git (push)

### To sync up with original repo
